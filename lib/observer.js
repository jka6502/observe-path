...
export default class Observer {
	...
	constructor(target, property) {
		...
		while(!definition && (chain = Object.getPrototypeOf(chain))) {
			definition = Object.getOwnPropertyDescriptor(chain, property);
		}
		...
		var { get, set, value, writable, enumerable } = definition;
		...
		// Store the original, not the resolved property descriptor, so that the
		// cleanup after unobserving correctly restores the original state.
